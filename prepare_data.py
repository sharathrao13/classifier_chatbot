...
TRAIN_PATH = os.path.join(FLAGS.input_dir, "train_small.csv")
VALIDATION_PATH = os.path.join(FLAGS.input_dir, "valid_small.csv")
TEST_PATH = os.path.join(FLAGS.input_dir, "test_small.csv")
